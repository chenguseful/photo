...
TWEEN.Group = _Group,
    ...
    TWEEN.Tween.prototype = {
        ...
        stop: function() {
            return this._isPlaying && (this._group.remove(this), this._isPlaying = !1, null !== this._onStopCallback && this._onStopCallback(this._object), this.stopChainedTweens()),
                this
        },
        end: function() {
        ...
        stopChainedTweens: function() {
            for (var t = 0,
                     n = this._chainedTweens.length; t < n; t++) this._chainedTweens[t].stop()
        },
        group: function(t) {
        ...
        update: function(t) {
            ...
            for (var o = 0,
                     u = this._chainedTweens.length; o < u; o++) this._chainedTweens[o].start(this._startTime + this._duration);
            return ! 1
        }
    },
    TWEEN.Easing = {
    ...
    TWEEN.Interpolation = {
        ...
        Bezier: function(t, n) {
            for (var e = 0,
                     ...
                     s = 0; s <= i; s++) e += r(1 - n, i - s) * r(n, s) * t[s] * a(i, s);
            return e
        },
