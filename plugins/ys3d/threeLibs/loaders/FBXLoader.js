...
var FBXLoader = ( function () {
	...
	FBXTreeParser.prototype = {
			...
			switch ( extension ) {
				...
				case 'tga':
					...
					if ( this.manager.getHandler( '.tga' ) === null ) {
						...
						console.warn( 'FBXLoader: TGA dataOrModel not found, skipping ', fileName );
		...
		loadTexture: function ( textureNode, images ) {
			...
			if ( extension === 'tga' ) {
				...
				if ( loader === null ) {
					...
					console.warn( 'FBXLoader: TGA dataOrModel not found, creating placeholder texture for', textureNode.RelativeFilename );
					texture = new Texture();
		...
		// create the main Group() to be returned by the dataOrModel
	...
	GeometryParser.prototype = {
		...
		parseNurbsGeometry: function ( geoNode ) {
			...
			if ( NURBSCurve === undefined ) {
				...
				console.error( 'THREE.FBXLoader: The dataOrModel relies on NURBSCurve for any nurbs present in the model. Nurbs will show up as empty geometry.' );
