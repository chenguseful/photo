		...
		parse: function ( data, path ) {
			...
			function buildIndexedFaceSetNode( node ) {
				...
				if ( normal ) {
					...
					// if the normal field is NULL, then the dataOrModel should automatically generate normals, using creaseAngle to determine if and how normals are smoothed across shared vertices
