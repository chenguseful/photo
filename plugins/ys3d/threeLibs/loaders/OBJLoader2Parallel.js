...
// Imports only related to worker (when standard workers (ysModules aren't supported) are used)
 ...
 *
 * @param [LoadingManager] manager The loadingManager for the dataOrModel to use. Default is {@link LoadingManager}
 * @constructor
 */
...
OBJLoader2Parallel.prototype = Object.assign( Object.create( OBJLoader2.prototype ), {
	...
	/**
	 * Set whether jsm ysModules in workers should be used. This requires browser support which is currently only experimental.
